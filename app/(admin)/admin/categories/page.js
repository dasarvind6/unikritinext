...
import { Container, Button, Modal, Form, Spinner, Alert, Badge, Card, ListGroup, InputGroup } from 'react-bootstrap';
import { 
          ...
          <Modal.Body className="p-4 px-lg-5">
            <div className="row">
              ...
              <div className="col-md-6 border-start ps-md-4">
                ...
                <Form.Text className="text-muted small">Select a single parent from the tree above.</Form.Text>
              </div>
            </div>
          </Modal.Body>
